...
// Retention markers from the MiniMax full-reference guide (section 4.1).
export const SUBJECT_RETENTIONS = Object.freeze([
    "fully_preserved", "partially_preserved", "attribute_transfer", "weak_reference",
]);
export const DEFAULT_SUBJECT_RETENTION = "fully_preserved";

// Mirror of prompt_payload.normalize_subject_ids: duplicates collapse (first
...
export function normalizeSubjectIds(raw) {
    ...
    for (const entry of raw) {
        ...
        out.push({
            entity_id: entityId,
            retention: SUBJECT_RETENTIONS.includes(retention)
                ? retention : DEFAULT_SUBJECT_RETENTION,
        });
    }
    return out;
}
