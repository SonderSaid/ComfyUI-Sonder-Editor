...
- Staged Reference rows read their declared role names, spell out **Create identity**, and say when nothing in the prompt refers to a staged Reference yet. Handle suggestions are short enough to type, follow the Name field while you write it, and are corrected as you type instead of only on refusal.
